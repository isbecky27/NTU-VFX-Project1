...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type = str, default = '../data/images', help = 'Path to the directory that contains series of images.')
    parser.add_argument('--result_path', type = str, default = '../data/results', help = 'Path to the directory that stores all of results.')
